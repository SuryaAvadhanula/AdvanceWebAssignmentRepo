  ...
  <div class='window'>
    ...
    <div class='content'>
      ...
      <div class='input-fields'>
        <input type='text' placeholder='FirstName' class='input-line full-width' v-model="firstName">
        <input type='text' placeholder='LastName' class='input-line full-width' v-model="lastName">
        <input type='text' placeholder='handle' class='input-line full-width' v-model="handle">
        <input type='email' placeholder='email' class='input-line full-width' v-model="email">
